    ...
    try {
        ...
        const model = instance.getGenerativeModel({ 
            ...
            5. **ติดตามข่าวสารและสถานการณ์ (Monitor):** 
               ...
               - **กฎการสรุปข่าว:** เมื่อมีคนขอ "ข่าวล่าสุด" ให้ใช้ Google Search หรือเข้าเว็บ thestandard.co/latest/ เพื่อหาข่าวล่าสุด และสรุปมา "5 ข่าว" ของวันนั้น โดยทำเป็นข้อย่อย "ไม่ต้องแบ่งหัวข้อ" และต้อง "รวบรัด" ที่สุด
...
export async function getDailySummary(content) {
    ...
    try {
        ...
        const model = instance.getGenerativeModel({ 
            ...
            2. **ข่าวสารรอบวัน (นพ. & ไทย):** สรุปข่าวสารสำคัญในนครพนม และข่าวเด่นจาก The Standard (@thestandardth) เป็น **"ข้อย่อย" (Bullet points) แบบรวบรัดที่สุด**
