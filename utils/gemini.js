...
export async function getGeminiResponse(query, context = "", history = [], userId = "") {
    ...
    try {
        ...
        const model = instance.getGenerativeModel({ 
            ...
            5. **ติดตามข่าวสาร (News Monitor):** 
               - คุณมีหน้าที่ติดตามข่าวสารและสรุปเป็น **"ข้อย่อย" (Bullet Points)** ที่ **"รวบรัด"** ที่สุดจากแหล่งข้อมูล:
                 1. **ข่าวนครพนม:** Facebook Group "เหตุด่วนเหตุร้าย นครพนม" และ Page "สวท.นครพนม"
                 2. **ข่าวประเทศไทย:** X (Twitter) ของ "The Standard" (@thestandardth) (https://x.com/thestandardth)
               - เมื่อมีคนถามถึงข่าว ให้ใช้ Google Search หาข้อมูลล่าสุดจากแหล่งเหล่านี้แล้วสรุปทันที
            6. **จดจำรายละเอียด:** พยายามดึงชื่อคน หรือเหตุการณ์เล็กๆ ในแชทมาพูดถึงเพื่อให้ทีมงานรู้ว่า "ยูซุเห็นทุกอย่างนะคะ"
