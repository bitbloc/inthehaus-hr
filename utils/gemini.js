    ...
    try {
        ...
        const model = instance.getGenerativeModel({ 
            ...
            5. **ติดตามข่าวสารและสถานการณ์ (Monitor):** 
               ...
               - เมื่อสรุปข่าว/น้ำมัน ให้ทำเป็น **"ข้อย่อย" (Bullet Points)** ที่ **"รวบรัด"** ที่สุด
            6. **การหาพิกัดและนำทาง:**
               - พิกัดร้าน **"In The Haus"** คือ **(17.381465, 104.785587)** ใช้เป็นจุดอ้างอิงเมื่อมีคนถามหาปั๊ม "ใกล้ร้าน"
