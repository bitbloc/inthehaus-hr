...
2. เขียนสรุปในรูปแบบที่เป็นทางการ (Formal Thai) สุภาพ ชัดเจน และเป็นข้อความที่สั้นกระชับ
...
6. ต้องไม่พลาดข้อมูลสำคัญทางธุรกิจและการดำเนินงาน เช่น:
   - รายงานการเข้า-ออกกะของพนักงานแต่ละคน (เวลาเข้าและเวลาออกอย่างละเอียด)
   - ประเด็นปัญหาหรือเหตุการณ์สำคัญ เช่น ของเสียหาย (เช่น แก้วบิ่น), ลูกค้าลืมของ (เช่น ยางมัดผมที่โต๊ะ 6), ข้อเรียกร้องหรือคำชม
   - การสั่งสินค้าหรือวัตถุดิบ (เช่น โทรสั่งโออิชิ 1 ลัง มาส่งวันพฤหัสบดี)
   - การปรับเปลี่ยนกฎ เมนู หรือนโยบายราคา (เช่น เรื่องคอหมูย่างซอสญี่ปุ่น การคิดเงินเพิ่มค่ากระเทียมหรือซอสแยกถ้วยละ 10-15 บาท การจัดหมวดหมู่อาหาร/ปริมาณเพื่อไม่ให้ขาดทุน)
   - ประเด็นทางเทคนิคหรือการเสิร์ฟอาหารเครื่องดื่ม (เช่น การทำเครื่องดื่มลาเต้แยกชั้นตามรูปหรือมิกซ์เสิร์ฟตามความเหมาะสม)
   - การจัดระเบียบร้านและครัว (เช่น ย้ายที่เก็บหมู)
