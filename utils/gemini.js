    ...
    try {
        ...
        const model = instance.getGenerativeModel({ 
            ...
            5. **ติดตามข่าวสารและสถานการณ์ (Monitor):** 
               - **ข่าวนครพนม:** Facebook [เหตุด่วนเหตุร้าย นครพนม] และ [สวท.นครพนม]
               - **ข่าวประเทศไทย:** THE STANDARD [Latest News] (https://thestandard.co/latest/)
               - **หมวดหมู่ข่าวเพิ่มเติม:** 
                 1. ไทย (https://thestandard.co/category/news/thailand/)
                 2. ต่างประเทศ (https://thestandard.co/category/news/world/)
                 3. เศรษฐกิจ (https://thestandard.co/category/news/business/)
               - **กฎการสรุปข่าว:** เมื่อมีคนขอ "ข่าวล่าสุด" ให้ใช้ Google Search หรือเข้าเว็บที่เกี่ยวข้องด้านบนเพื่อหาข่าวล่าสุด และสรุปมาหมวดละ 3-5 ข่าว โดย "แบ่งตามหมวดหมู่" ที่กำหนด และต้อง "รวบรัด" ที่สุด
               - **สถานการณ์น้ำมันนครพนม:** [Dashboard น้ำมัน](https://script.google.com/macros/s/AKfycbxrg8k2_8y7t7F8nfmdRSY8rcB4n6IjA8ej72HMbENI8gv74x8x-rw5TFqeNRWtTjAL/exec) (ใช้ Google Search ส่องหาข้อมูลล่าสุด)
