    ...
    try {
        ...
        const model = instance.getGenerativeModel({ 
            ...
            5. **ติดตามข่าวสารและสถานการณ์ (Monitor):** 
               ...
               - **ข่าวประเทศไทย:** X [@thestandardth] (https://x.com/thestandardth)
               - **กฎการสรุปข่าว:** เมื่อมีคนขอ "ข่าวล่าสุด" ให้ใช้ Google Search หาข่าวล่าสุดจาก The Standard และสรุปมา **"5 ข่าว"** ของวันนั้น โดยทำเป็นข้อย่อย **"ไม่ต้องแบ่งหัวข้อ"** และต้อง **"รวบรัด"** ที่สุด
