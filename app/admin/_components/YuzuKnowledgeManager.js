...
export default function YuzuKnowledgeManager() {
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #1c1c1c; padding-bottom: 20px; margin-bottom: 30px;">
                    <div style="display: flex; align-items: center; gap: 15px;">
                        ...
                        <div>
                            ...
                            <div style="font-size: 9px; font-weight: 700; color: #737373; tracking-wider: 0.1em; text-transform: uppercase; margin-top: 2px;">Daily Operations Report / รายงานสรุปการปฏิบัติงานรายวัน</div>
                        </div>
                    </div>
                    <div style="text-align: right;">
                        <div style="font-size: 16px; font-weight: 700; color: #1c1c1c;">DATE: ${dateStr}</div>
                        <div style="font-size: 8px; font-weight: 600; color: #a3a3a3; text-transform: uppercase; margin-top: 4px;">Generated: ${new Date().toLocaleTimeString('th-TH', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}</div>
                    </div>
                </div>
    ...
    async function handleExportThreeDayReportPDF() {
        ...
        try {
            ...
            for (const date of datesToFetch) {
                sectionsHtml += `
                    <div style="margin-bottom: 30px; page-break-inside: avoid;">
                        <div style="display: inline-block; background: #1c1c1c; color: #ffffff; padding: 5px 12px; font-size: 10px; font-weight: 700; text-transform: uppercase; border-radius: 6px; margin-bottom: 12px; letter-spacing: 0.05em;">
                            REPORT DATE: ${date}
                        </div>
                        <div style="background: #ffffff; border: 1px solid #e5e5e7; border-radius: 16px; padding: 25px; font-size: 12px; line-height: 1.75; color: #262626; white-space: pre-wrap;">
            ...
            element.innerHTML = `
                <!-- Header -->
                <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #1c1c1c; padding-bottom: 20px; margin-bottom: 35px;">
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <img src="/logo.png" style="height: 40px; width: auto; object-fit: contain;" alt="In The Haus Logo" />
                        <div>
                            <div style="font-size: 18px; font-weight: 800; tracking-widest: 0.05em; line-height: 1.2;">IN THE HAUS</div>
                            <div style="font-size: 9px; font-weight: 700; color: #737373; tracking-wider: 0.1em; text-transform: uppercase; margin-top: 2px;">3-Day Compilation Report / รายงานสรุปปฏิบัติงานย้อนหลัง 3 วัน</div>
                        </div>
                    </div>
                    <div style="text-align: right;">
                        <div style="font-size: 14px; font-weight: 700; color: #1c1c1c;">3-DAY SUMMARY LOGS</div>
                ...
                <!-- Footer -->
                <div style="border-top: 1px solid #e5e5e7; padding-top: 20px; display: flex; justify-content: space-between; align-items: flex-end; margin-top: 40px;">
                    <div style="max-width: 450px;">
                        <div style="font-size: 8px; font-weight: 750; text-transform: uppercase; color: #a3a3a3; letter-spacing: 0.1em; margin-bottom: 5px;">Verification & Archives</div>
                        <div style="font-size: 8px; line-height: 1.5; color: #a3a3a3;">
                            This compiled document is an official historical log report compiled by Yuzu AI for In The Haus Nakhon Phanom. 
                            Any modifications must be authorized by management.
                        </div>
                    </div>
                    <div style="text-align: right;">
        ...
        <div className="space-y-6">
            ...
            {activeTab === 'insights' && (
                <div className="space-y-6">
                    ...
                    {/* AI Operations Briefing (Full Width) */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        {/* Staff Mood Timeline */}
                        <Card className="p-6 space-y-4 max-h-[380px] overflow-y-auto custom-scrollbar rounded-sm bg-rams-panel border border-rams-rule-light shadow-none">
