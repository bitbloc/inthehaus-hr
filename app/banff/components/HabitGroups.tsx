...
import { FaHeart, FaBrain, FaWallet, FaLeaf, FaLayerGroup } from 'react-icons/fa';
...
export default function HabitGroups({ habits, logs }: HabitGroupsProps) {
    ...
    // Order groups based on Lifestyles order
    // We render known lifestyles first, then uncategorized if any
    return (
