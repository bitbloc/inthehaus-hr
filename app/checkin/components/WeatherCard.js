                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 shrink-0 ml-2">
                                ...
                                <button
                                    ...
                                    className={`w-8 h-8 rounded-sm flex items-center justify-center border border-rams-rule-light transition-[transform,background-color] duration-150 active:translate-y-[1px] tactile-btn-sm ${
                                        showRadar 
